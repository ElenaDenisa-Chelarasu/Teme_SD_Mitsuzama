...
open class AuctioneerMicroservice {
    ...
    private fun receiveBid(message: Message){
    ...
    protected fun forwardBid(message: Message) {
        messageProcessorSocket.getOutputStream().write(message.serialize())
    }

    protected fun endBid() {
...
class JournalizedAuctioneerMicroservice:AuctioneerMicroservice() {
    private val journalizer: InFileJournalizer = object : InFileJournalizer(){
