...
class WeatherAppController {
    ...
    @Autowired
    private lateinit var weatherAppControllerWeatherForecastService: WeatherForecastInterface
    @Autowired
